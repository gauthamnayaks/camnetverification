...
rm -f ./results_deterministic.csv
echo 'n,i+,i-,d+,d-,s+,s-,c,states' >> ./results_deterministic.csv
python process_results.py >> ./results_deterministic.csv
sed -i 's/,/,\t/g' ./results_deterministic.csv
#rm -f results.csv
rm -f *.flip
rm *.all *.sta
