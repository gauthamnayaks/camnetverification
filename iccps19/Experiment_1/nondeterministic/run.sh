...
rm -f ./results_nondeterministic.csv
echo 'n,i+,i-,d+,d-,s+,s-,c,states' >> ./results_nondeterministic.csv
python process_results.py >> ./results_nondeterministic.csv
sed -i 's/,/,\t/g' ./results_nondeterministic.csv
#rm -f results.csv
rm -f *.flip
rm *.all *.sta
